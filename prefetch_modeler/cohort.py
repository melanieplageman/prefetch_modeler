...
from prefetch_modeler.prefetcher_type import BaselineSync, BaselineFetchAll
...
class Cohort:
    """
    DataFrames generated by running a list of prefetch algorithms and both
    baselines for a given workload and storage type
    """
    def __init__(self):
        self.members = []
    ...
    def run(self, storage, workload, prefetchers):
        ...
        self.members.append(Member(storage, workload, [BaselineFetchAll]))
        self.members.append(Member(storage, workload, [BaselineSync]))
